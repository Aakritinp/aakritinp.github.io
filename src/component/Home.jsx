  ...
  return (
    <div>
      ...
      <section id="summary">
        ...
        <div className="card">
          <p>
            Highly accomplished <strong>Software Engineer</strong> with
            extensive experience in building end-to-end web applications and
            enterprise solutions. Expert in{" "}
            <strong>Java, Spring Boot, Hibernate, and RESTful APIs</strong> for
            robust backend development, coupled with proficiency in{" "}
            <strong>Angular, React, JavaScript, and HTML/CSS</strong> for
            dynamic and responsive frontend design. Adept at developing
            applications following <strong>Microservices Architecture</strong>,
          ...
          <p>
            ...
            <strong>Junit</strong> and <strong>Mockito</strong> for unit
            testing.
          </p>
          <p>
            Well-versed in <strong>Agile methodologies</strong> and
            collaborating with cross-functional teams to deliver high-quality,
            on-time solutions. Strong understanding of{" "}
            <strong>Object-Oriented Programming (OOP)</strong>,{" "}
            <strong>Data Structures</strong>, and{" "}
            <strong>Design Patterns</strong>, ensuring efficient and
            maintainable code. Passionate about leveraging{" "}
            <strong>Cloud Platforms</strong> like <strong>AWS</strong> and{" "}
            <strong>Azure</strong> to design and deploy highly available and
